...
namespace TpBridge
{
    class Program
    {
        ...
        {
            TempBridge bridge = new TempBridge();


            bridge.SetDevicePortName("COM5");
            Console.ReadKey();

            Console.WriteLine(bridge.SelfCheck().ToString());
            Console.ReadKey();
        ...
        public class TempBridge
        {
            ...
            public bool SetDevicePortName(string portName)
            {
                ...
                {
                    Console.WriteLine("继电器设备新建串口时发生异常：" + ex.Message);
                    return false;
                }
            ...
            public bool SelfCheck()
            {
                ...
                {
                    Console.WriteLine("传感器设备 " + cmd.ToString() + " 异常: " + ex.Message);
                    // 关闭串口
                    try { sPort.Close(); } catch { }
                    return false;
                }
